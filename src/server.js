    ...
    components: {
      ...
      schemas: {
        User: {
          type: 'object',
          properties: {
            user_id: { type: 'string', example: 'user_lkj3h2g1h2k3' },
            full_name: { type: 'string', example: 'Nguyễn Văn A' },
            email: { type: 'string', format: 'email', example: 'user@example.com' },
            phone: { type: 'string', example: '0901234567' },
            role: { type: 'string', enum: ['donor', 'charity', 'admin', 'dao_member'], example: 'donor' },
        ...
        Campaign: {
          ...
          properties: {
            ...
            status: { type: 'string', enum: ['active', 'completed', 'pending', 'paused', 'cancelled'] },
